      ...
      <div className="flex gap-8">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              ...
              <div className="flex-1 ml-4">
                <h3 className="text-x1 font-semibold mb-2">Makis Serum</h3>

                <p className="text-gray-600 mb-2">Description</p>
                <div className="flex items-center my-5 p-4">
                  <FaMinus className="bg-gray-600 text-white cursor-pointer pr-2 rounded-full" />
                  <span className="text-lg font-semibold mx-4">1</span>
                  <FaPlus className="bg-gray-600 text-white cursor-pointer pl-2 rounded-full" />
                </div>
              </div>
              <div className="text-right">
                <p className="text-xl font-bold mb-6"> $100</p>
        ...
        <div className="w-80 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button className="bg-red-400 text-white p-3 w-full rounded-lg font-semibold">
              Proceed to Checkout
            </button>
          </div>
        </div>
